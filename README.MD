...
1. ~~Create a Node/Express application from scratch using the MongoDB database.~~ 
...
17. ~~Include security protections for your application. Incl. security packages like xss-clean and helmet, appropriately configured.~~
...
5.  ~~listen on server~~
6.  ~~set up controllers & routes structures~~
7.  ~~connect to db~~  
...
19. ~~implement mongoose pre Save & ObjectId~~
20. ~~dynamically set authorization header~~
21. ~~handle mongoose validation errors~~
22. ~~add security packages~~
23. ~~deploy to render~~
24. ~~apply front-end~~
25. ~~style with css~~
26. add finishing touches to front-end*
27. build out movie record model*
28. build game model
28. edit README & commentary*
29. create & import film db*
30. implement query params/searching/sorting/paging*
31. swagger documentation*
32. implement tests*
33. apply EJS? 
34. connect databases?
35.
